...
INSERT INTO statistics (hit_points, resistance, speed, line_of_sight, population, xp_train_bounty, xp_bounty)
VALUES (170, '20% vs Melee', 4.5, 16, 1, 12, 12),
       (500,'10% vs Range',4.5,16,1,NULL,NULL),
       (500,'10% vs Melee',4,12,1,NULL,NULL),
       (105,'50% vs Ranged',4.5,22,1,12,12),
       (100,'20% vs Ranged',4.0,20,1,8,8),
       (230,'20% vs Melee',4.5,12,2,20,20),
       (115,'30% vs Ranged',4,24,1,12,12),
       (200,'10% vs Melee',4,12,1,12,12),
       (235,'20% vs Melee',4,16,1,13,13),
       (95,'30% vs Ranged',4,24,1,10,10),
       (150,'20% vs Melee',4,16,1,10,10),
       (120,'10% vs Melee',5,12,1,4,8),
       (150,'20% vs Melee',5,12,1,14,14),
       (135,'40% vs Melee',6,12,1,10,10),
       (230,'30% vs Melee',4.5,12,2,20,20),
       (190,'20% vs Melee',4,16,1,12,12),
       (120,'30% vs Ranged',4,24,1,12,12),
       (72,'30% vs Ranged',4.5,16,1,6,6),
       (100,'30% vs Ranged',4,22,1,11,11),
       (175,'30% vs Melee',5,12,6,20,20),
       (265,'30% vs Melee',6.75,14,2,16,16),
       (225,'30% vs Ranged',6.75,16,1,15,15),
       (500,'20% vs Ranged',6.25,15,3,30,30),
       (200,'30% vs Ranged',7.25,15,2,18,18),
       (320,'20% vs Ranged',6.75,15,2,20,20),
       (350,'30% vs Ranged',6.5,15,2,20,20),
       (300,'30% vs Ranged',6.8,15,2,20,20),
       (250,'20% vs Ranged',6.75,15,2,15,15),
       (140,'10% vs Ranged',7.25,14,1,11,11),
       (190,'30% vs Ranged',6.75,12,2,15,15),
       (500,'20% vs Melee',6,22,3,30,30),
       (200,'50% vs Ranged',6.8,22,2,21,21),
       (130,'20% vs Ranged',4,22,2,15,15),
       (280,'75% vs Ranged',3.5,36,4,50,50),
       (200,'75% vs Ranged',4.0,30,5,50,50),
       (150,'75% vs Ranged',4,26,4,40,40),
       (200,'50% vs Ranged',4,15,2,18,18),
       (200,'20% vs Melee',4,15,2,18,18),
       (200,'75% vs Ranged',6,30,6,60,60),
       (300,'75% vs Ranged',3,44,4,45,45),
       (150,'75% vs Ranged',4,30,4,40,40),
       (225,'40% vs Ranged',4,15,1,15,15),
       (2000,'75% vs Ranged',7.5,24,NULL,60,60),
       (220,'50% vs Ranged',8.5,24,NULL,10,10),
       (800,'50% vs Ranged',8.5,26,NULL,40,40),
       (400,'50% vs Ranged',9,40,NULL,20,20),
       (200,'50% vs Ranged',4,10,1,10,10),
       (1000,'75% vs Ranged',8.5,26,NULL,60,60),
       (2000,'75% vs Ranged',7.5,34,NULL,100,100),
       (2500,'75% vs Ranged',7.5,34,NULL,120,120),
       (800,'50% vs Ranged',9,26,NULL,40,40),
       (1500,'75% vs Ranged',8.5,26,NULL,80,80),
       (600,'60% vs Ranged',10,26,NULL,40,40),
       (2000,'75% vs Ranged',7.5,34,NULL,NULL,100),
       (220,'50% vs Ranged',8.5,24,NULL,10,10),
       (1200,'50% vs Ranged',6.5,38,NULL,100,100),
       (2000,'75% vs Ranged',7.5,34,NULL,100,100),
       (800,'50% vs Ranged',8.5,26,NULL,40,40),
       (1500,'75% vs Ranged',7.5,38,NULL,80,80),
       (475,'75% vs Ranged',3.5,32,7,70,70),
       (475,'75% vs Ranged',3.5,32,7,70,70),
       (350,'75% vs Ranged',4,32,6,60,60),
       (150,'20% vs Melee',4,14,1,5,10),
       (200,'10% vs Ranged',4,26,NULL,5,5),
       (200,'20% vs Melee',4,14,1,NULL,NULL),
       (120,'10% vs Ranged',5.5,22,1,NULL,14),
       (180,'40% vs Ranged',4.5,18,1,12,12),
       (400,'10% vs Ranged',4.5,18,NULL,NULL,45),
       (360,'10% vs Ranged',4,12,1,20,20),
       (300,'10% vs Ranged',7,12,1,20,20),
       (360,'10% vs Ranged',4,12,1,20,20),
       (150,'20% vs Ranged',6.25,28,2,20,20),
       (240,'10% vs Ranged',4,12,1,30,30),
       (1,'NULL',1,1,1,1,1),
       (1,'NULL',1,1,1,1,1),
       (1,'NULL',1,1,1,1,1),
       (1,'NULL',1,1,1,1,1),
       (1,'NULL',1,1,1,1,1),
       (1,'NULL',1,1,1,1,1),
       (225,'30% vs Ranged',7.5,20,2,16,16),
       (120,'30% vs Ranged',7.5,15,1,12,12),
       (917,'30% vs Ranged',6,15,7,65,65),
       (667,'20% vs Ranged',5.5,20,6,60,60),
       (1,'nasd',1,1,1,1,1),
       (325,'50% vs Ranged',4,15,4,30,30),
       (210,'64% vs Ranged',4.25,14,4,34,34),
       (175,'75% vs Ranged',3,34,4,40,40),
       (100,'50% vs Ranged',3,38,1,14,14),
       (1,'dsfdsf',1,1,1,1,1),
       (225,'75% vs Ranged',2.5,44,3,35,35),
       (700,'30% vs Ranged',4,29,7,70,70),
       (130,'20% vs Melee',4,15,1,NULL,NULL),
       (120,'10% vs Melee',5,12,1,NULL,NULL),
       (150,'20% vs Melee',4,14,1,10,10),
       (20,'1',1,1,1,1,1),
       (20,'1',1,1,1,1,1),
       (20,'1',1,1,1,1,1),
       (20,'1',1,1,1,1,1),
